# Google Earth Engine script / GEE 脚本说明

**English** — Paste into [Code Editor](https://code.earthengine.google.com/) or use the .js file.

**中文** — 粘贴到 [代码编辑器](https://code.earthengine.google.com/) 或直接使用同目录 .js 文件。
